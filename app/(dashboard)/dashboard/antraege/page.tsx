...
import ContactsTable from "@/components/dashboard/data-request-table";
            ...
            <div className="max-lg:hidden lg:contents">
              ...
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbItem>
                    <BreadcrumbPage>Anträge</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="space-y-1">
              ...
              <p className="text-sm text-muted-foreground">
                Hier finden Sie eine Übersicht über alle Ihre Datenanfragen.
                Verwalten Sie bestehende Anträge oder erstellen Sie neue
                Anfragen.
              </p>
            </div>
            <Button className="px-3">Neue Anfrage</Button>
          </div>
          {/* Numbers */}
          <StatsGrid
            stats={[
